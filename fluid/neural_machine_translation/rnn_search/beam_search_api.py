...
class BeamSearchDecoder(object):
    """
    A beam search decoder that can be used for inference. The decode process
    can be defined within its block.
    ...
    def read_array(self, init, is_ids=False, is_scores=False):
        """
        Read an array to get the variable generated by previous RNN step. At the
        first step of RNN, the init variable will be used to initialize the
        array.
    ...
    def update_array(self, array, value):
        """
        Store the value generated in current step in an array. This array could
        be accessed by read_array method.
